# Microsoft Face API: iOS Client Library
This repo contains the iOS client library & sample for the Microsoft Face API, part of [Cognitive Services](https://www.microsoft.com/cognitive-services).
